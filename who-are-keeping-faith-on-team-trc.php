...
class team extends database
{
    ...
    {
        $sql = "SELECT * from team where type = 'faith'";
        ...
        <div role="main" class="main">
                ...
                <div class="container py-5">
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <h1 class="text-color-light font-weight-bold text-10">Who Are Keeping Faith On Team Trc</h1>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container py-5 my-4">
                <h2 class="text-color-dark font-weight-extra-bold text-10 mb-4 appear-animation"
                    data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200"><em>Who are keeping faith
                        on team trc</em>
                </h2>
