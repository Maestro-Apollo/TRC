                ...
                <div class="container py-5">
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <h1 class="text-color-light font-weight-bold text-10">Article Details</h1>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container">
                <div class="row pb-4">
                    <div class="col-lg-8 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorterPlus"
                        ...
                        <img src="img/Alimijjaman - Copy.jpg"
                            class="img-fluid float-right custom-box-shadow-1 ml-4 mb-3" alt="" />
